...
pub mod api_server {
    ...
    pub trait Api: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn check_nullifiers_by_prefix(
            &self,
            request: tonic::Request<super::super::requests::CheckNullifiersByPrefixRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::responses::CheckNullifiersByPrefixResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/rpc.Api/CheckNullifiersByPrefix" => {
                        ...
                        > for CheckNullifiersByPrefixSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Api>::check_nullifiers_by_prefix(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/rpc.Api/GetAccountProofs" => {
                    ...
                    impl<T: Api>
                        tonic::server::UnaryService<super::super::requests::GetAccountProofsRequest>
                ...
                "/rpc.Api/SyncNotes" => {
                    ...
                    impl<T: Api>
                        tonic::server::UnaryService<super::super::requests::SyncNoteRequest>
                        for SyncNotesSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move { <T as Api>::sync_notes(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
